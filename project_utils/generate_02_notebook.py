...
add_md(
    "The notebook explains the steps, but the actual dataset should be processed with a script. "
    "The companion CLI supports:\n"
    "- one image only\n"
    "- specific scenes\n"
    "- skipping selected scenes or images\n"
    "- the full database at once\n\n"
    "Example commands:\n\n"
    "```bash\n"
